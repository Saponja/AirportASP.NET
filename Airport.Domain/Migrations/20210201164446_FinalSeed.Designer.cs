...
namespace Airport.Domain.Migrations
{
    ...
    [Migration("20210201164446_FinalSeed")]
            ...
            modelBuilder.Entity("Airport.Domain.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeatId = 2,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 2, 1, 17, 44, 44, 911, DateTimeKind.Local).AddTicks(5052)
                        },
                        new
                        {
                            SeatId = 14,
                            PassangerId = 1,
                            DateOfReservation = new DateTime(2021, 2, 1, 17, 44, 44, 919, DateTimeKind.Local).AddTicks(3316)
                        },
                        new
                        {
                            SeatId = 4,
                            PassangerId = 2,
                            DateOfReservation = new DateTime(2021, 2, 1, 17, 44, 44, 919, DateTimeKind.Local).AddTicks(3430)
                        },
                        new
                        {
                            SeatId = 11,
                            PassangerId = 3,
                            DateOfReservation = new DateTime(2021, 2, 1, 17, 44, 44, 919, DateTimeKind.Local).AddTicks(3447)
                        },
                        new
                        {
                            SeatId = 6,
                            PassangerId = 4,
                            DateOfReservation = new DateTime(2021, 2, 1, 17, 44, 44, 919, DateTimeKind.Local).AddTicks(3455)
                        });
                });
